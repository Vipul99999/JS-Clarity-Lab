...
const staticRoutes = ["/", "/start", "/paths", "/clinic", "/concepts", "/discover", "/analyze", "/node-playground", "/quality", "/why"];
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [...staticRoutes, ...pathRoutes, ...topicRoutes, ...demoRoutes].map((route) => ({
    url: `${siteUrl}${route}`,
    lastModified: now,
